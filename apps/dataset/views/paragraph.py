...
class Paragraph(APIView):
    ...
    @swagger_auto_schema(
        operation_summary=_("Paragraph list"),
    ...
    @swagger_auto_schema(
        operation_summary=_("Create Paragraph"),
    ...
    class Problem(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Add associated questions"),
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get a list of paragraph questions"),
        ...
        class UnAssociation(APIView):
            ...
            @swagger_auto_schema(
                operation_summary=_("Disassociation issue"),
        ...
        class Association(APIView):
            ...
            @action(methods=["PUT"], detail=False)
            @swagger_auto_schema(
                operation_summary=_("Related questions"),
    ...
    class Operate(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_("Modify paragraph data"),
        ...
        @action(methods=["UPDATE"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get paragraph details"),
        ...
        @swagger_auto_schema(
            operation_summary=_("Delete paragraph"),
    ...
    class Batch(APIView):
        ...
        @action(methods=["DELETE"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Delete paragraphs in batches"),
        ...
        @log(
            menu="Paragraph",
            operate="Delete paragraphs in batches",
            get_operation_object=lambda r,
            keywords: get_dataset_document_operation_object(
                get_dataset_operation_object(keywords.get("dataset_id")),
                get_document_operation_object(keywords.get("document_id")),
    ...
    class Page(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get paragraph list by pagination"),
