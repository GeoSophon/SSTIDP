...
from dataset.views.common import (
    get_dataset_document_operation_object,
...
class Template(APIView):
    ...
    @swagger_auto_schema(
        operation_summary=_("Get QA template"),
...
class TableTemplate(APIView):
    ...
    @action(methods=["GET"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Get form template"),
...
class WebDocument(APIView):
    ...
    @swagger_auto_schema(
        operation_summary=_("Create Web site documents"),
...
class QaDocument(APIView):
    ...
    @action(methods=["POST"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Import QA and create documentation"),
...
class TableDocument(APIView):
    ...
    @action(methods=["POST"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Import tables and create documents"),
...
class Document(APIView):
    ...
    @action(methods=["POST"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Create document"),
    ...
    @action(methods=["GET"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Document list"),
    ...
    class BatchEditHitHandling(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Modify document hit processing methods in batches"),
        ...
        @log(
            ...
            get_operation_object=lambda r,
            keywords: get_dataset_document_operation_object(
                get_dataset_operation_object(keywords.get("dataset_id")),
    ...
    class Batch(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Create documents in batches"),
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Batch sync documents"),
    ...
    class SyncWeb(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_("Synchronize web site types"),
    ...
    class CancelTask(APIView):
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Cancel task"),
        ...
        class Batch(APIView):
            ...
            @action(methods=["PUT"], detail=False)
            @swagger_auto_schema(
                operation_summary=_("Cancel tasks in batches"),
    ...
    class Refresh(APIView):
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Refresh document vector library"),
    ...
    class BatchRefresh(APIView):
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Batch refresh document vector library"),
    ...
    class Migrate(APIView):
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Migrate documents in batches"),
    ...
    class Export(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Export document"),
    ...
    class ExportZip(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Export Zip document"),
    ...
    class Operate(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get document details"),
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Modify document"),
        ...
        @action(methods=["DELETE"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Delete document"),
    ...
    class SplitPattern(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get a list of segment IDs"),
    ...
    class Split(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Segmented document"),
    ...
    class Page(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get the knowledge base paginated list"),
    ...
    class BatchGenerateRelated(APIView):
        ...
        @log(
            menu="document",
            operate="Batch generate related documents",
            get_operation_object=lambda r,
            keywords: get_dataset_document_operation_object(
                get_dataset_operation_object(keywords.get("dataset_id")),
