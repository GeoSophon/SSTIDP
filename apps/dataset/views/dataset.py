...
class Dataset(APIView):
    ...
    class SyncWeb(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_("Synchronize the knowledge base of the website"),
        ...
        @log(
            ...
            get_operation_object=lambda r, keywords: get_dataset_operation_object(
    ...
    class CreateQADataset(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_("Create QA knowledge base"),
        ...
        @log(
            menu="Knowledge Base",
            operate="Create QA knowledge base",
            get_operation_object=lambda r, keywords: {
    ...
    class CreateWebDataset(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Create a web site knowledge base"),
    ...
    class Application(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_(
                "Get a list of applications available in the knowledge base"
            ),
            operation_id=_(
                "Get a list of applications available in the knowledge base"
            ),
    ...
    @action(methods=["GET"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Get a list of knowledge bases"),
    ...
    @action(methods=["POST"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Create a knowledge base"),
    ...
    @log(
        menu="Knowledge Base",
        operate="Create a knowledge base",
        get_operation_object=lambda r, keywords: {
            "name": r.data.get("name"),
            "desc": r.data.get("desc"),
        },
    ...
    class Embedding(APIView):
        ...
        @action(methods="PUT", detail=False)
        @swagger_auto_schema(
            operation_summary=_("Re-vectorize"),
    ...
    class Export(APIView):
        ...
        @action(methods="GET", detail=False)
        @swagger_auto_schema(
            operation_summary=_("Export knowledge base"),
            operation_id=_("Export knowledge base"),
            manual_parameters=DataSetSerializers.Operate.get_request_params_api(),
            tags=[_("Knowledge Base")],
        )
        @has_permissions(
    ...
    class ExportZip(APIView):
        ...
        @action(methods="GET", detail=False)
        @swagger_auto_schema(
            operation_summary=_("Export knowledge base containing images"),
    ...
    class Operate(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_("Delete knowledge base"),
            operation_id=_("Delete knowledge base"),
            manual_parameters=DataSetSerializers.Operate.get_request_params_api(),
            responses=result.get_default_response(),
            tags=[_("Knowledge Base")],
        )
        ...
        @swagger_auto_schema(
            operation_summary=_(
                "Query knowledge base details based on knowledge base id"
            ),
        ...
        @action(methods="PUT", detail=False)
        @swagger_auto_schema(
            operation_summary=_("Modify knowledge base information"),
        ...
        def get(self, request: Request, dataset_id: str):
            return result.success(
                ModelSerializer.Query(
                    data={"user_id": request.user.id, "model_type": "LLM"}
