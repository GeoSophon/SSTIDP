...
class Problem(APIView):
    ...
    @swagger_auto_schema(
        operation_summary=_("Question list"),
    ...
    @swagger_auto_schema(
        operation_summary=_("Create question"),
    ...
    class Paragraph(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get a list of associated paragraphs"),
    ...
    class OperateBatch(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_("Batch deletion issues"),
    ...
    class Operate(APIView):
        ...
        @action(methods=["DELETE"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Delete question"),
        ...
        @swagger_auto_schema(
            operation_summary=_("Modify question"),
    ...
    class Page(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get the list of questions by page"),
