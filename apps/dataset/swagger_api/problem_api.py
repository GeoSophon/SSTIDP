...
class ProblemApi(ApiMixin):
    ...
    class BatchAssociation(ApiMixin):
        ...
        def get_request_body_api():
            return openapi.Schema(
                ...
                properties={
                    "problem_id_list": openapi.Schema(
                        type=openapi.TYPE_ARRAY,
                        title=_("problem id list"),
                        description=_("problem id list"),
                        items=openapi.Schema(type=openapi.TYPE_STRING),
                    ),
                    "paragraph_list": openapi.Schema(
                        type=openapi.TYPE_ARRAY,
                        title=_("Associated paragraph information list"),
                        ...
                        items=openapi.Schema(
                            ...
                            properties={
                                "paragraph_id": openapi.Schema(
                                    type=openapi.TYPE_STRING, title=_("paragraph id")
                                ),
                                "document_id": openapi.Schema(
                                    type=openapi.TYPE_STRING, title=_("document id")
                                ),
                            },
                        ),
                    ),
    ...
    class Create(ApiMixin):
        ...
        def get_request_body_api():
            return openapi.Schema(
                type=openapi.TYPE_STRING, description=_("content"), title=_("content")
            )
