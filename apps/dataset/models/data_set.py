...
class DataSet(AppModelMixin):
    ...
    type = models.CharField(
        verbose_name="类型", max_length=1, choices=Type.choices, default=Type.base
    )
    embedding_mode = models.ForeignKey(
        Model,
...
class Document(AppModelMixin):
    ...
    status = models.CharField(
        verbose_name="状态", max_length=20, default=Status("").__str__
    )
...
class Problem(AppModelMixin):
    ...
    dataset = models.ForeignKey(
        DataSet, on_delete=models.DO_NOTHING, db_constraint=False
    )
