        ...
        return openapi.Schema(
            ...
            properties={
                ...
                "chat_id": openapi.Schema(
                    type=openapi.TYPE_STRING, title=_("Conversation ID")
                ),
                "re_chat": openapi.Schema(
                    type=openapi.TYPE_BOOLEAN, title=_("regenerate"), default=False
                ),
                "stream": openapi.Schema(
                    type=openapi.TYPE_BOOLEAN, title=_("Stream Output"), default=True
                ),
            },
        )
        ...
        return openapi.Schema(
            ...
            properties={
                ...
                "stream": openapi.Schema(
                    ...
                    title=_("Is it streaming output"),
                    default=True,
                ),
                ...
                "image_list": openapi.Schema(
                    ...
                    items=openapi.Schema(
                        ...
                        properties={
                            "name": openapi.Schema(
                                type=openapi.TYPE_STRING, title=_("Image name")
                            ),
                            "url": openapi.Schema(
                                type=openapi.TYPE_STRING, title=_("Image URL")
                            ),
                ...
                "document_list": openapi.Schema(
                    ...
                    items=openapi.Schema(
                        ...
                        properties={
                            # 定义对象的具体属性
                            "name": openapi.Schema(
                                type=openapi.TYPE_STRING, title=_("Document name")
                            ),
                            "url": openapi.Schema(
                                type=openapi.TYPE_STRING, title=_("Document URL")
                            ),
                            "file_id": openapi.Schema(type=openapi.TYPE_STRING),
                        },
                    ),
                ...
                "audio_list": openapi.Schema(
                    ...
                    items=openapi.Schema(
                        ...
                        properties={
                            "name": openapi.Schema(
                                type=openapi.TYPE_STRING, title=_("Audio name")
                            ),
                            "url": openapi.Schema(
                                type=openapi.TYPE_STRING, title=_("Audio URL")
                            ),
                            "file_id": openapi.Schema(type=openapi.TYPE_STRING),
                        },
                    ),
                ...
                "runtime_node_id": openapi.Schema(
                    type=openapi.TYPE_STRING,
                    title=_("Runtime node id"),
                    description=_("Runtime node id"),
                    default="",
                ),
                "node_data": openapi.Schema(
                    type=openapi.TYPE_OBJECT,
                    title=_("Node data"),
                ...
                "chat_record_id": openapi.Schema(
                    type=openapi.TYPE_STRING,
                    title=_("Conversation record id"),
                    description=_("Conversation record id"),
                    default="",
                ),
                "child_node": openapi.Schema(
                    type=openapi.TYPE_STRING,
                    title=_("Child node"),
        ...
        return openapi.Schema(
            ...
            properties={
                ...
                "chat_id": openapi.Schema(
                    ...
                    description=_("Conversation ID"),
                    default=_("Conversation ID"),
                ),
                "chat_record_count": openapi.Schema(
                    type=openapi.TYPE_STRING,
                    title=_("Number of dialogue questions"),
                    description=_("Number of dialogue questions"),
                    default=0,
                ),
                "mark_sum": openapi.Schema(
                    type=openapi.TYPE_STRING,
                    title=_("Number of tags"),
                    description=_("Number of tags"),
                    default=1,
                ),
                "star_num": openapi.Schema(
                    type=openapi.TYPE_STRING,
                    title=_("Number of likes"),
                ...
                "trample_num": openapi.Schema(
                    ...
                    description=_("Number of clicks"),
                    default=1,
                ),
    ...
    def get_response_body_api():
        return openapi.Schema(
            ...
            properties={
                ...
                "chat": openapi.Schema(
                    type=openapi.TYPE_STRING,
                    title=_("Session log id"),
                    description=_("Conversation log id"),
                    default=_("Conversation log id"),
                ),
                "vote_status": openapi.Schema(
                    type=openapi.TYPE_STRING,
                    title=_("Voting Status"),
                    description=_("Voting Status"),
                    default=_("Voting Status"),
                ),
                ...
                "message_tokens": openapi.Schema(
                    ...
                    description=_("Number of tokens consumed by the question"),
                    default=0,
                ),
        ...
        return openapi.Schema(
            ...
            properties={
                ...
                "content": openapi.Schema(
                    ...
                    title=_("Paragraph content"),
                    description=_("Paragraph content"),
                    default=_("Paragraph content"),
                ),
                "title": openapi.Schema(
                    type=openapi.TYPE_STRING,
                    title=_("title"),
                    description=_("title"),
                    default=_("Description of xxx"),
                ),
                "hit_num": openapi.Schema(
                    type=openapi.TYPE_INTEGER,
                    title=_("Number of hits"),
                ...
                "trample_num": openapi.Schema(
                    type=openapi.TYPE_INTEGER,
                    title=_("Number of thumbs-downs"),
                    description=_("Number of thumbs-downs"),
                    default=1,
                ),
                "dataset_id": openapi.Schema(
                    type=openapi.TYPE_STRING,
