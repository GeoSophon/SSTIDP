...
class ApplicationApi(ApiMixin):
    ...
    def get_response_body_api():
        return openapi.Schema(
            ...
            properties={
                "id": openapi.Schema(
                    type=openapi.TYPE_STRING, title="", description=_("Primary key id")
                ),
                "name": openapi.Schema(
                    type=openapi.TYPE_STRING,
                ...
                "dialogue_number": openapi.Schema(
                ...
                "example": openapi.Schema(
                    ...
                    title=_("Example List"),
                    description=_("Example List"),
                ),
                "user_id": openapi.Schema(
                    type=openapi.TYPE_STRING,
                    title=_("Affiliation user"),
                    description=_("Affiliation user"),
                ),
                "status": openapi.Schema(
                    type=openapi.TYPE_BOOLEAN,
                    title=_("Is publish"),
                    description=_("Is publish"),
                ),
            ...
            return openapi.Schema(
                ...
                properties={
                    ...
                    "access_num": openapi.Schema(
                        type=openapi.TYPE_NUMBER,
                        title=_("Number of visits"),
                        description=_("Number of visits"),
                    ),
                    "white_active": openapi.Schema(
                        type=openapi.TYPE_BOOLEAN,
                        title=_("Whether to enable whitelist"),
        ...
        def get_request_body_api():
            return openapi.Schema(
                ...
                properties={
                    ...
                    "problem_optimization_prompt": openapi.Schema(
                        type=openapi.TYPE_STRING,
                    ...
                    "tts_model_id": openapi.Schema(
                        type=openapi.TYPE_STRING,
                        title=_("Text-to-speech model ID"),
                        description=_("Text-to-speech model ID"),
                    ),
                    "stt_model_id": openapi.Schema(
                        type=openapi.TYPE_STRING,
                        title=_("Speech-to-text model id"),
                        description=_("Speech-to-text model id"),
                    ),
                    "stt_model_enable": openapi.Schema(
                        type=openapi.TYPE_STRING,
                        title=_("Is speech-to-text enabled"),
                        description=_("Is speech-to-text enabled"),
                    ),
                    "tts_model_enable": openapi.Schema(
                        type=openapi.TYPE_STRING,
                        title=_("Is text-to-speech enabled"),
                        description=_("Is text-to-speech enabled"),
                    ),
                    "tts_type": openapi.Schema(
                        type=openapi.TYPE_STRING,
                        title=_("Text-to-speech type"),
            ...
            return openapi.Schema(
                ...
                properties={
                    "nodes": openapi.Schema(
                        ...
                        title=_("Node List"),
                        description=_("Node List"),
                        default=[],
                    ),
                    "edges": openapi.Schema(
                        type=openapi.TYPE_ARRAY,
                        items=openapi.Schema(type=openapi.TYPE_OBJECT),
                        title=_("Connection List"),
                        description=_("Connection List"),
                        default=[],
                    ),
                },
            )
            ...
            return openapi.Schema(
                ...
                properties={
                    "top_n": openapi.Schema(
                        type=openapi.TYPE_NUMBER,
                        title=_("Reference segment number"),
                    ...
                    "no_references_setting": openapi.Schema(
                        ...
                        properties={
                            "status": openapi.Schema(
                                type=openapi.TYPE_STRING,
                                title=_("state"),
                                description=_("ai_questioning|designated_answer"),
            ...
            return openapi.Schema(
                ...
                properties={
                    ...
                    "system": openapi.Schema(
                        type=openapi.TYPE_STRING,
                        title=_("System prompt words (role)"),
                        description=_("System prompt words (role)"),
                    ),
                    "no_references_prompt": openapi.Schema(
                        type=openapi.TYPE_STRING,
            ...
            return openapi.Schema(
                ...
                properties={
                    ...
                    "problem_optimization": openapi.Schema(
                        type=openapi.TYPE_BOOLEAN,
                        title=_("Problem Optimization"),
                        description=_("Problem Optimization"),
                        default=True,
                    ),
                    "type": openapi.Schema(
                        type=openapi.TYPE_STRING,
    ...
    class TextToSpeech(ApiMixin):
        ...
        def get_request_body_api():
            return openapi.Schema(
                ...
                properties={
                    "text": openapi.Schema(
                        type=openapi.TYPE_STRING, title=_("Text"), description=_("Text")
                    ),
                },
            )
