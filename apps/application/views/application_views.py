...
class ApplicationStatistics(APIView):
    class CustomerCount(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_("User Statistics"),
    ...
    class CustomerCountTrend(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("User demographic trends"),
    ...
    class ChatRecordAggregate(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Conversation statistics"),
    ...
    class ChatRecordAggregateTrend(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Dialogue-related statistical trends"),
...
class Application(APIView):
    ...
    class EditIcon(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_("Modify application icon"),
        ...
        @log(
            menu="Application",
            operate="Modify application icon",
    ...
    class Import(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_("Import Application"),
            operation_id=_("Import Application"),
        ...
        def post(self, request: Request):
            return result.success(
                ApplicationSerializer.Import(
                    data={"user_id": request.user.id, "file": request.FILES.get("file")}
                ).import_()
            )
    ...
    class Export(APIView):
        ...
        @action(methods="GET", detail=False)
        @swagger_auto_schema(
            operation_summary=_("Export Application"),
            operation_id=_("Export Application"),
    ...
    class Embed(APIView):
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get embedded js"),
    ...
    class Model(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get a list of models"),
    ...
    class ModelParamsForm(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get model parameter form"),
    ...
    class FunctionLib(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get a list of function libraries"),
        ...
        class Operate(APIView):
            ...
            @action(methods=["GET"], detail=False)
            @swagger_auto_schema(
                operation_summary=_("Get library details"),
    ...
    class Application(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get the list of apps created by the current user"),
        ...
        class Operate(APIView):
            ...
            @action(methods=["GET"], detail=False)
            @swagger_auto_schema(
                operation_summary=_("Get application data"),
    ...
    class Profile(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get application related information"),
    ...
    class ApplicationKey(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Add ApiKey"),
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get the application API_KEY list"),
        ...
        class Operate(APIView):
            ...
            @action(methods=["PUT"], detail=False)
            @swagger_auto_schema(
                operation_summary=_("Modify application API_KEY"),
            ...
            @swagger_auto_schema(
                operation_summary=_("Delete Application API_KEY"),
    ...
    class AccessToken(APIView):
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Modify Application AccessToken"),
        ...
        @log(
            menu="Application",
            operate="Modify Application AccessToken",
            get_operation_object=lambda r, k: get_application_operation_object(
                k.get("application_id")
            ),
        )
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get the application AccessToken information"),
    ...
    class Authentication(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Application Certification"),
    ...
    @action(methods=["POST"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Create an application"),
    ...
    @action(methods=["GET"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Get the application list"),
    ...
    class HitTest(APIView):
        ...
        @action(methods="GET", detail=False)
        @swagger_auto_schema(
            operation_summary=_("Hit Test List"),
    ...
    class Publish(APIView):
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Publishing an application"),
    ...
    class Operate(APIView):
        ...
        @action(methods=["DELETE"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Deleting application"),
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Modify the application"),
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get application details"),
    ...
    class ListApplicationDataSet(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_(
                "Get the knowledge base available to the current application"
            ),
            operation_id=_(
                "Get the knowledge base available to the current application"
            ),
    ...
    class Page(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get the application list by page"),
    ...
    class TextToSpeech(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("text to speech"),
    ...
    class McpServers(APIView):
        ...
        def get(self, request: Request):
            return result.success(
                ApplicationSerializer.McpServers(
                    data={"mcp_servers": request.query_params.get("mcp_servers")}
                ).get_mcp_servers()
            )
