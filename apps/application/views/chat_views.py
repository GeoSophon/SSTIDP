...
from application.serializers.chat_message_serializers import (
...
class Openai(APIView):
    ...
    @swagger_auto_schema(
        operation_summary=_("OpenAI Interface Dialogue"),
...
class ChatView(APIView):
    ...
    class Export(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Export conversation"),
        ...
        @log(
            menu="Conversation Log",
            operate="Export conversation",
    ...
    class Open(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_("Get the session id according to the application id"),
    ...
    class OpenWorkFlowTemp(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get the workflow temporary session id"),
    ...
    class OpenTemp(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get a temporary session id"),
        ...
        def post(self, request: Request, chat_id: str):
            return ChatMessageSerializer(
                data={
                    ...
                    "document_list": request.data.get("document_list")
                    if "document_list" in request.data
                    else [],
                    "audio_list": request.data.get("audio_list")
                    if "audio_list" in request.data
                    else [],
                    "client_type": request.auth.client_type,
    ...
    @action(methods=["GET"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Get the conversation list"),
    ...
    class Operate(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_("Delete a conversation"),
    ...
    class ClientChatHistoryPage(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get client conversation list by paging"),
        ...
        class Operate(APIView):
            ...
            @action(methods=["DELETE"], detail=False)
            @swagger_auto_schema(
                operation_summary=_("Client deletes conversation"),
            ...
            @log(
                menu="Conversation Log",
                operate="Client deletes conversation",
                get_operation_object=lambda r, k: get_application_operation_object(
                    k.get("application_id")
                ),
            )
            ...
            @swagger_auto_schema(
                operation_summary=_("Client modifies dialogue summary"),
            ...
            @log(
                menu="Conversation Log",
                operate="Client modifies dialogue summary",
                get_operation_object=lambda r, k: get_application_operation_object(
                    k.get("application_id")
                ),
            )
    ...
    class Page(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get the conversation list by page"),
    ...
    class ChatRecord(APIView):
        ...
        class Operate(APIView):
            ...
            @action(methods=["GET"], detail=False)
            @swagger_auto_schema(
                operation_summary=_("Get conversation record details"),
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get a list of conversation records"),
        ...
        class Page(APIView):
            ...
            @action(methods=["GET"], detail=False)
            @swagger_auto_schema(
                operation_summary=_("Get the conversation history list by page"),
        ...
        class Vote(APIView):
            ...
            @action(methods=["PUT"], detail=False)
            @swagger_auto_schema(
                operation_summary=_("Like, Dislike"),
        ...
        class ChatRecordImprove(APIView):
            ...
            @action(methods=["GET"], detail=False)
            @swagger_auto_schema(
                operation_summary=_("Get the list of marked paragraphs"),
        ...
        class Improve(APIView):
            ...
            @action(methods=["PUT"], detail=False)
            @swagger_auto_schema(
                operation_summary=_("Annotation"),
            ...
            @action(methods=["POST"], detail=False)
            @swagger_auto_schema(
                operation_summary=_("Add to Knowledge Base"),
            ...
            def post(self, request: Request, application_id: str, dataset_id: str):
                return result.success(
                    ChatRecordSerializer.PostImprove().post_improve(request.data)
                )
            ...
            class Operate(APIView):
                ...
                @action(methods=["DELETE"], detail=False)
                @swagger_auto_schema(
                    operation_summary=_("Delete a Annotation"),
    ...
    class UploadFile(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Upload files"),
