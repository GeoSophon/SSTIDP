...
from application.serializers.application_version_serializers import (
...
class ApplicationVersionView(APIView):
    ...
    @swagger_auto_schema(
        ...
        responses=result.get_api_array_response(
            ApplicationVersionApi.get_response_body_api()
        ),
    ...
    class Page(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get the list of application versions by page"),
    ...
    class Operate(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get application version details"),
        ...
        @swagger_auto_schema(
            operation_summary=_("Modify application version information"),
