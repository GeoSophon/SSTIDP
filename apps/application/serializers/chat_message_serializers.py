...
class ChatInfo:
    ...
    def to_base_pipeline_manage_params(self):
        ...
        return {
            ...
            "similarity": dataset_setting.get("similarity")
            ...
            "search_mode": self.application.dataset_setting.get("search_mode")
...
class ChatMessageSerializer(serializers.Serializer):
    ...
    def chat_work_flow(self, chat_info: ChatInfo, base_to_response):
        ...
        work_flow_manage = WorkflowManage(
            ...
            self.data.get("node_data"),
            chat_record,
            self.data.get("child_node"),
        )
    ...
    def re_open_chat_simple(chat_id, application):
        ...
        chat_info = ChatInfo(
            chat_id, dataset_id_list, exclude_document_id_list, application
        )
