...
class ApplicationVersionSerializer(serializers.Serializer):
    class Query(serializers.Serializer):
        ...
        def get_query_set(self):
            query_set = QuerySet(WorkFlowVersion).filter(
    ...
    class Operate(serializers.Serializer):
        ...
        work_flow_version_id = serializers.UUIDField(
            required=True, error_messages=ErrMessage.uuid(_("Workflow version id"))
        )
        ...
        def one(self, with_valid=True):
            ...
            work_flow_version = (
                ...
                .filter(
                    application_id=self.data.get("application_id"),
                    id=self.data.get("work_flow_version_id"),
                )
                .first()
            )
