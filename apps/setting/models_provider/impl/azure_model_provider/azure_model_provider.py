...
from setting.models_provider.impl.azure_model_provider.credential.embedding import (
    AzureOpenAIEmbeddingCredential,
)
from setting.models_provider.impl.azure_model_provider.credential.image import (
...
from setting.models_provider.impl.azure_model_provider.credential.stt import (
    AzureOpenAISTTModelCredential,
)
from setting.models_provider.impl.azure_model_provider.credential.tti import (
    AzureOpenAITextToImageModelCredential,
)
from setting.models_provider.impl.azure_model_provider.credential.tts import (
    AzureOpenAITTSModelCredential,
)
from setting.models_provider.impl.azure_model_provider.model.azure_chat_model import (
    AzureChatModel,
)
from setting.models_provider.impl.azure_model_provider.model.embedding import (
    AzureOpenAIEmbeddingModel,
)
from setting.models_provider.impl.azure_model_provider.model.image import (
    AzureOpenAIImage,
)
from setting.models_provider.impl.azure_model_provider.model.stt import (
    AzureOpenAISpeechToText,
)
from setting.models_provider.impl.azure_model_provider.model.tti import (
    AzureOpenAITextToImage,
)
from setting.models_provider.impl.azure_model_provider.model.tts import (
