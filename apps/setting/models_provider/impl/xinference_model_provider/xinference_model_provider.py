...
from setting.models_provider.impl.xinference_model_provider.credential.image import (
...
from setting.models_provider.impl.xinference_model_provider.credential.reranker import (
    XInferenceRerankerModelCredential,
)
from setting.models_provider.impl.xinference_model_provider.credential.stt import (
    XInferenceSTTModelCredential,
)
from setting.models_provider.impl.xinference_model_provider.credential.tti import (
    XinferenceTextToImageModelCredential,
)
from setting.models_provider.impl.xinference_model_provider.credential.tts import (
    XInferenceTTSModelCredential,
)
from setting.models_provider.impl.xinference_model_provider.model.embedding import (
    XinferenceEmbedding,
)
from setting.models_provider.impl.xinference_model_provider.model.image import (
    XinferenceImage,
)
from setting.models_provider.impl.xinference_model_provider.model.llm import (
    XinferenceChatModel,
)
from setting.models_provider.impl.xinference_model_provider.model.reranker import (
    XInferenceReranker,
)
from setting.models_provider.impl.xinference_model_provider.model.stt import (
    XInferenceSpeechToText,
)
from setting.models_provider.impl.xinference_model_provider.model.tti import (
    XinferenceTextToImage,
)
from setting.models_provider.impl.xinference_model_provider.model.tts import (
