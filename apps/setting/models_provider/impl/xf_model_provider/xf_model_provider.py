...
from setting.models_provider.impl.xf_model_provider.credential.embedding import (
    XFEmbeddingCredential,
)
from setting.models_provider.impl.xf_model_provider.credential.image import (
...
from setting.models_provider.impl.xf_model_provider.credential.stt import (
    XunFeiSTTModelCredential,
)
from setting.models_provider.impl.xf_model_provider.credential.tts import (
...
model_info_manage = (
    ...
    .append_default_model_info(
        ModelInfo(
            "tts", "", ModelTypeConst.TTS, tts_model_credential, XFSparkTextToSpeech
        )
    )
    .append_default_model_info(
        ModelInfo(
