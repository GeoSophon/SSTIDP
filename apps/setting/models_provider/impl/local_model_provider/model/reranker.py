...
class LocalReranker(MaxKBBaseModel):
    ...
    def new_instance(
        ...
        if model_kwargs.get("use_local", True):
            return LocalBaseReranker(
                model_name=model_name,
                cache_dir=model_credential.get("cache_dir"),
                model_kwargs={"device": model_credential.get("device", "cpu")},
            )
        return WebLocalBaseReranker(
            model_name=model_name,
            cache_dir=model_credential.get("cache_dir"),
...
class LocalBaseReranker(MaxKBBaseModel, BaseDocumentCompressor):
    ...
    def new_instance(
        ...
        return LocalBaseReranker(
            model_name, cache_dir=model_credential.get("cache_dir"), **model_kwargs
        )
