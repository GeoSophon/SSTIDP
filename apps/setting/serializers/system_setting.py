    ...
    class EmailSerializer(serializers.Serializer):
        ...
        class Create(serializers.Serializer):
            email_host = serializers.CharField(
                required=True, error_messages=ErrMessage.char(_("SMTP host"))
            )
            email_port = serializers.IntegerField(
                required=True, error_messages=ErrMessage.char(_("SMTP port"))
            )
            email_host_user = serializers.CharField(
                required=True, error_messages=ErrMessage.char(_("Sender's email"))
            )
            ...
            email_use_tls = serializers.BooleanField(
                required=True,
                error_messages=ErrMessage.char(_("Whether to enable TLS")),
            )
