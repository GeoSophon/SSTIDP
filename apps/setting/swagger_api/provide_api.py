        ...
        def get_response_body_api():
            return openapi.Schema(
                ...
                properties={
                    "key": openapi.Schema(
                        type=openapi.TYPE_STRING,
                        title=_("model type description"),
                        description=_("model type description"),
                        default=_("large language model"),
                    ),
                    "value": openapi.Schema(
                        type=openapi.TYPE_STRING,
                        title=_("model type value"),
                        description=_("model type value"),
                        default="LLM",
                    ),
                },
            )
