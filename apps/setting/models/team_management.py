...
class Team(AppModelMixin):
    ...
    user = models.OneToOneField(
        User, primary_key=True, on_delete=models.DO_NOTHING, verbose_name="团队所有者"
    )
...
class TeamMember(AppModelMixin):
    ...
    user = models.ForeignKey(
        User, on_delete=models.DO_NOTHING, verbose_name="成员用户id"
    )
...
class TeamMemberPermission(AppModelMixin):
    ...
    member = models.ForeignKey(
        TeamMember, on_delete=models.DO_NOTHING, verbose_name="团队成员"
    )
