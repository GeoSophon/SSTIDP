...
from setting.views.common import (
    get_member_operation_object,
    get_member_operation_object_batch,
)
...
class TeamMember(APIView):
    ...
    @swagger_auto_schema(
        operation_summary=_("Add member"),
    ...
    class Batch(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Add members in batches"),
        ...
        @log(
            menu="Team",
            operate="Add members in batches",
    ...
    class Operate(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get team member permissions"),
        ...
        @swagger_auto_schema(
            operation_summary=_("Update team member permissions"),
        ...
        @log(
            menu="Team",
            operate="Update team member permissions",
            get_operation_object=lambda r, k: get_member_operation_object(
                k.get("member_id")
            ),
        )
        ...
        @swagger_auto_schema(
            operation_summary=_("Remove member"),
