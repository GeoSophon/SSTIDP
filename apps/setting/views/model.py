...
from setting.serializers.provider_serializers import (
    ProviderSerializer,
    ModelSerializer,
...
class Model(APIView):
    ...
    @swagger_auto_schema(
        operation_summary=_("Create model"),
    ...
    @swagger_auto_schema(
        operation_summary=_("Download model, trial only with Ollama platform"),
    ...
    @swagger_auto_schema(
        operation_summary=_("Get model list"),
    ...
    class PauseDownload(APIView):
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Pause model download"),
    ...
    class ModelParamsForm(APIView):
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Save model parameter form"),
        ...
        def put(self, request: Request, model_id: str):
            return result.success(
                ModelSerializer.ModelParamsForm(
                    data={"id": model_id, "user_id": request.user.id}
    ...
    class Operate(APIView):
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Update model"),
        ...
        @swagger_auto_schema(
            operation_summary=_("Delete model"),
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Query model details"),
...
class Provide(APIView):
    ...
    class Exec(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Call the supplier function to obtain form data"),
    ...
    @action(methods=["GET"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Get a list of model suppliers"),
    ...
    class ModelTypeList(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get a list of model types"),
    ...
    class ModelList(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get the model creation form"),
    ...
    class ModelParamsForm(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get model default parameters"),
            operation_id=_("Get the model creation form"),
            manual_parameters=ProvideApi.ModelList.get_request_params_api(),
            responses=result.get_api_array_response(
                ProvideApi.ModelList.get_response_body_api()
