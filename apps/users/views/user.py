...
class Profile(APIView):
    ...
    @swagger_auto_schema(
        operation_summary=_("Get MaxKB related information"),
...
class User(APIView):
    ...
    @action(methods=["GET"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Get current user information"),
    ...
    class Query(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get user list"),
...
class SwitchUserLanguageView(APIView):
    ...
    @swagger_auto_schema(
        operation_summary=_("Switch Language"),
...
class ResetCurrentUserPasswordView(APIView):
    ...
    @action(methods=["POST"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Modify current user password"),
...
class SendEmailToCurrentUserView(APIView):
    ...
    @swagger_auto_schema(
        operation_summary=_("Send email to current user"),
...
class Register(APIView):
    ...
    @permission_classes((AllowAny,))
    @swagger_auto_schema(
        operation_summary=_("User registration"),
...
class RePasswordView(APIView):
    ...
    @permission_classes((AllowAny,))
    @swagger_auto_schema(
        operation_summary=_("Change password"),
...
class CheckCode(APIView):
    ...
    @permission_classes((AllowAny,))
    @swagger_auto_schema(
        operation_summary=_("Check whether the verification code is correct"),
...
class SendEmail(APIView):
    @action(methods=["POST"], detail=False)
    @swagger_auto_schema(
        operation_summary=_("Send email"),
...
class UserManage(APIView):
    ...
    class Page(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get user paginated list"),
    ...
    class Operate(APIView):
        ...
        @action(methods=["PUT"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Update user information"),
...
class UserListView(APIView):
    ...
    @swagger_auto_schema(
        operation_summary=_("Get user list by type"),
