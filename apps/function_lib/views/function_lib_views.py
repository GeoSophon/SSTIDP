...
class FunctionLibView(APIView):
    ...
    @swagger_auto_schema(
        operation_summary=_("Get function list"),
    ...
    @swagger_auto_schema(
        operation_summary=_("Create function"),
    ...
    class Debug(APIView):
        ...
        @action(methods=["POST"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Debug function"),
    ...
    class Operate(APIView):
        ...
        @swagger_auto_schema(
            operation_summary=_("Update function"),
        ...
        @log(
            ...
            get_operation_object=lambda r, k: get_function_lib_operation_object(
                k.get("function_lib_id")
            ),
        )
        ...
        @swagger_auto_schema(
            operation_summary=_("Delete function"),
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get function details"),
    ...
    class Page(APIView):
        ...
        @action(methods=["GET"], detail=False)
        @swagger_auto_schema(
            operation_summary=_("Get function list by pagination"),
    ...
    class Import(APIView):
        ...
        @action(methods="POST", detail=False)
        @swagger_auto_schema(
            operation_summary=_("Import function"),
            operation_id=_("Import function"),
    ...
    class Export(APIView):
        ...
        @action(methods="GET", detail=False)
        @swagger_auto_schema(
            operation_summary=_("Export function"),
            operation_id=_("Export function"),
