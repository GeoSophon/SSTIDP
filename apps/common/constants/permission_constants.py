...
class RoleConstants(Enum):
    ...
    APPLICATION_ACCESS_TOKEN = (
        Role(
            _("chat"),
            _("Only has application dialog interface permissions"),
            RoleGroup.APPLICATION_ACCESS_TOKEN,
        ),
    )
    APPLICATION_KEY = Role(
        _("Apply private key"), _("Apply private key"), RoleGroup.APPLICATION_KEY
    )
